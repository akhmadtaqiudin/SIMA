...
<body>
	<div class="easyui-layout" id="main">
        ...
        <div data-options="region:'center',title:'Reject Pengadaan Barang'" class="center">
            <div class="view">
        		<div class="errors">
				  ...
				  <s:form namespace="/pengadaanBarang" method="post" theme="bootstrap" cssClass="form-horizontal" >
					...
					<s:textarea name="pengadaan.keterangan" label="Alasan Reject " labelSeparator=":" />
					<div class="footer">
						<s:submit action="Pengadaan" value="Cansel" cssClass="btn btn-default"/>
						<s:submit action="RejectPengadaan" value="Reject" cssClass="btn btn-danger"/>
					</div>
			    </s:form>
			</div>
        </div>

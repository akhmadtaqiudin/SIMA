        		...
        		<div class="errors">
				  ...
				  <s:form namespace="/pengadaanBarang" method="post" theme="bootstrap" cssClass="form-horizontal" >
					...
					<div class="footer">
						...
						<s:submit action="AccPengadaan" value="Acc" cssClass="btn btn-primary"/>
					</div>
			    </s:form>
			</div>
        </div>

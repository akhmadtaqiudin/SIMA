...
<body>
	<div class="easyui-layout" id="main">
        ...
        <div data-options="region:'center',title:'Data Penggunaan Ruangan Kepala Sekolah'" class="center">
        	<div class="view">
			  <s:form namespace="/penggunaanBarang" id="form">
				...
				<s:submit value="Search" action="RuangKepalaSekolah" cssClass="btn btn-default btn-sm btnSrc2" />
			  ...
			  <display:table id="listTablePenggunaan" name="listPenggunaan" pagesize="10"
				 requestURI="/penggunaanBarang/RuangKepalaSekolah.action" class="table table-bordered table-hover table-striped" >

        ...
        <div data-options="region:'center',title:'Data Penggunaan Kelas 6'" class="center">
        	<div class="view">
			  <s:form namespace="/penggunaanBarang" id="form">
				...
				<s:submit value="Search" action="Kelas6" cssClass="btn btn-default btn-sm btnSrc2" />
			  ...
			  <display:table id="listTablePenggunaan" name="listPenggunaan" pagesize="10"
				 requestURI="/penggunaanBarang/Kelas6.action" class="table table-bordered table-hover table-striped" >

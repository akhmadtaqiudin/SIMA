        ...
        <div data-options="region:'center',title:'Data Penggunaan Kelas 2'" class="center">
        	<div class="view">
			  <s:form namespace="/penggunaanBarang" id="form">
				...
				<s:submit value="Search" action="Kelas2" cssClass="btn btn-default btn-sm btnSrc2" />
			  ...
			  <display:table id="listTablePenggunaan" name="listPenggunaan" pagesize="10"
				 requestURI="/penggunaanBarang/Kelas2.action" class="table table-bordered table-hover table-striped" >

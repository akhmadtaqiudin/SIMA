...
<body>
	<div class="easyui-layout" id="main">
        ...
        <div data-options="region:'center',title:'Data Penggunaan Sarana Musholla'" class="center">
        	<div class="view">
			  <s:form namespace="/penggunaanBarang" id="form">
				...
				<s:submit value="Search" action="Musholla" cssClass="btn btn-default btn-sm btnSrc2" />
			  ...
			  <display:table id="listTablePenggunaan" name="listPenggunaan" pagesize="10"
				 requestURI="/penggunaanBarang/Musholla.action" class="table table-bordered table-hover table-striped" >

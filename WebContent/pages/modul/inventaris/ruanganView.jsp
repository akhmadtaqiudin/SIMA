...
<body>
	<div class="easyui-layout" id="main">
       <div data-options="region:'west',split:true" title="Dasboard" id="west">
        ...
        <div data-options="region:'center',title:'View Data Ruangan'" class="center">
        	<div class="view">
			  <s:form namespace="/masterRuangan" method="post" theme="bootstrap" cssClass="form-horizontal" >
				<s:textfield name="ruangan.kodeRuangan" label="Kode Ruangan " labelSeparator=":" readonly="true" />
				<s:textfield name="ruangan.namaRuangan" label="Nama Ruangan " labelSeparator=":" readonly="true"/>

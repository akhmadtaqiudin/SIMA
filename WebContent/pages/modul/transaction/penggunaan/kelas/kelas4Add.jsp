        ...
        <div data-options="region:'center',title:'Add Penggunaan Barang'" class="center">
        	...
        	<div class="errors">
			  ...
			  <s:form namespace="/penggunaanBarang" method="post" theme="bootstrap" cssClass="form-horizontal" >
				<s:hidden name="penggunaan.kodeRuangan" value="KAR0016"/>
				...
				<div class="footer">
					<s:submit action="SearchKelas4" value="Cansel" cssClass="btn btn-default"/>
					<s:submit action="SavePenggunaanKelas4" value="Save" cssClass="btn btn-primary"/>
				</div>
			</s:form>
			</div>
        </div>

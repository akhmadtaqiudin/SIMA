        ...
        <div data-options="region:'center',title:'Add Penggunaan Barang'" class="center">
        	...
        	<div class="errors">
			  ...
			  <s:form namespace="/penggunaanBarang" method="post" theme="bootstrap" cssClass="form-horizontal" >
				<s:hidden name="penggunaan.kodeRuangan" value="KAR0018"/>
				...
				<div class="footer">
					<s:submit action="SearchKelas6" value="Cansel" cssClass="btn btn-default"/>
					<s:submit action="SavePenggunaanKelas6" value="Save" cssClass="btn btn-primary"/>
				</div>
			</s:form>
			</div>
        </div>

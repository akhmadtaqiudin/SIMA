        ...
        <div data-options="region:'center',title:'Add Penggunaan Barang'" class="center">
        	...
        	<div class="errors">
			  ...
			  <s:form namespace="/penggunaanBarang" method="post" theme="bootstrap" cssClass="form-horizontal" >
				<s:hidden name="penggunaan.kodeRuangan" value="KAR0002"/>
				...
				<div class="footer">
					<s:submit action="SearchPerpus" value="Cansel" cssClass="btn btn-default"/>
					<s:submit action="SavePenggunaanPerpus" value="Save" cssClass="btn btn-primary"/>
				</div>
			</s:form>
			</div>
        </div>

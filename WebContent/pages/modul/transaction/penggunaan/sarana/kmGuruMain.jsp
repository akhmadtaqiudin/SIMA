...
<body>
	<div class="easyui-layout" id="main">
        ...
        <div data-options="region:'center',title:'Data Penggunaan Kamar Mandi Guru'" class="center">
        	<div class="view">
			  <s:form namespace="/penggunaanBarang" id="form">
				...
				<s:submit value="Search" action="SearchKamarMandiGuru" cssClass="btn btn-default btn-sm btnSrc" />
				<input value="Reset" class="btn btn-default btn-sm btnRst" />
				<s:submit value="Add data" action="AddPenggunaanKamarMandiGuru" cssClass="btn btn-success btn-sm btnAdd" />
			  </s:form>
			  <display:table id="listTablePenggunaan" name="listPenggunaan" pagesize="10"
				 requestURI="/penggunaanBarang/SearchKamarMandiGuru.action" class="table table-bordered table-hover table-striped" >
				...
				<display:column title="Action">
				  ...
				  <a class="btn btn-danger btn-xs" href="${pageContext.request.contextPath}/penggunaanBarang/DeletPenggunaanKmGuru.action?penggunaan.kodePenggunaan=<%=((Penggunaan) pageContext.getAttribute("listTablePenggunaan")).getKodePenggunaan()%>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Delete</a>

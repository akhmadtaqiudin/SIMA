        ...
        <div data-options="region:'center',title:'Add Penggunaan Barang'" class="center">
        	...
        	<div class="errors">
			  ...
			  <s:form namespace="/penggunaanBarang" method="post" theme="bootstrap" cssClass="form-horizontal" >
			  	<s:hidden name="penggunaan.kodeRuangan" value="KAR0001"/>
				...
				<div class="footer">
					<s:submit action="SearchMusholla" value="Cansel" cssClass="btn btn-default"/>
					<s:submit action="SavePenggunaanMusholla" value="Save" cssClass="btn btn-primary"/>
				</div>
			</s:form>
			</div>
        </div>

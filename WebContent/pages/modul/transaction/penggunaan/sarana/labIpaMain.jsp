        	...
        	<div class="view">
			  ...
			  <display:table id="listTablePenggunaan" name="listPenggunaan" pagesize="10"
				...
				<display:column title="Action">
				  ...
				  <a class="btn btn-danger btn-xs" href="${pageContext.request.contextPath}/penggunaanBarang/DeletPenggunaanLab.action?penggunaan.kodePenggunaan=<%=((Penggunaan) pageContext.getAttribute("listTablePenggunaan")).getKodePenggunaan()%>">Delete</a>

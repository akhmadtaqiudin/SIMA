...
<body>
	<div class="easyui-layout" id="main">
        ...
        <div data-options="region:'center',title:'Add Penggunaan Kamar Mandi Serbaguna'" class="center">
        	<div class="view">
        	<div class="errors">
			  ...
			  <s:form namespace="/penggunaanBarang" method="post" theme="bootstrap" cssClass="form-horizontal" >
				<s:hidden name="penggunaan.kodeRuangan" value="KAR0012"/>
				...
				<div class="footer">
					<s:submit action="SearchKamarMandiSerbaguna" value="Cansel" cssClass="btn btn-default"/>
					<s:submit action="SavePenggunaanKamarMandiSerbaguna" value="Save" cssClass="btn btn-primary"/>
				</div>
			</s:form>
			</div>
        </div>

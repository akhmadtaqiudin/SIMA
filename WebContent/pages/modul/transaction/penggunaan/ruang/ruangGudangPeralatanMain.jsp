        ...
        <div data-options="region:'center',title:'Data Penggunaan Gudang Peralatan'" class="center">
        	<div class="view">
			  <s:form namespace="/penggunaanBarang" id="form">
				...
				<s:submit value="Add data" action="AddPenggunaanGudangPeralatan" cssClass="btn btn-success btn-sm btnAdd" />
			  </s:form>
			  <display:table id="listTablePenggunaan" name="listPenggunaan" pagesize="10"
				 requestURI="/penggunaanBarang/SearchGudangPeralatan.action" class="table table-bordered table-hover table-striped" >
